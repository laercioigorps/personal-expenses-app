...
urlpatterns = [
    ...
    path('acategoria/<int:id>', views.detail_cattegory_view,name='cattegory_detail'),
    path('categoria/<int:id>/editar', views.edit_cattegory_view,name='cattegory_edit'),
    path('categoria/<int:id>/deletar', views.delete_cattegory_view,name='cattegory_delete'),
    ...
    path('categorias/<int:month>/<int:year>', views.list_cattegory_by_month_year_view, name='cattegory_list_by_month_year'),
    ...
    path('transacao/<int:id>', views.detail_transaction_view,name='transaction_detail'),
    path('transacao/<int:id>/edit', views.edit_transaction_view,name='transaction_edit'),
    path('transacao/<int:id>/delete', views.delete_transaction_view,name='transaction_delete'),
    path('transacoes/list/', views.list_transaction_view, name='transaction_list'),
    path('transacoes/<int:month>/<int:year>', views.list_transaction_view_by_month, name='transaction_list_by_month_year'),
